// April 28, 2023 - this is for looking at the Escan - not for the paper.
// attempt to make it look as much like jam1ana7.C as possible
// for looking at v3
// Jamana7 now uses rapidity/ybeam
...
void smash2ana7(int itype=5,int ntodo=-1, int irot=0, int i_inject=0, double Ecm=7.7, double bmin=0., double bmax=14.) {
  ...
  TH2D *xvsz_allnh = new TH2D("xvsz_allnh","xvszh all participant nucleons",1000,-200.,200.,1000,-200.,200.);
  ...
  TH2D *xvszh = new TH2D("xvszh","xvszh all part nucleons eta>etamin",600,-150.,150.,1000,-200.,200.);
  ...
  TH2D *xvszybeamh = new TH2D("xvszybeamh","xvszybeamh all part nucleons eta>ybeam",600,-150.,150.,1000,-200.,200.);
  ...
  TH2D *xvszspech = new TH2D("xvszspech","xvszspech",600,-150.,150.,1000,-200.,200.);
...
// note eps_3=sqrt(eps_x^2+eps_y^2)/rsq1 - vs rapidity, pt, b
  ...
  TProfile *eps_x_rapidity_ptcut1_cent_pr_h = new TProfile("eps_x_rapidity_ptcut1_cent_pr_h","eps_x_rapidity_ptcut1_cent_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_x_rapidity_ptcut2_cent_pr_h = new TProfile("eps_x_rapidity_ptcut2_cent_pr_h","eps_x_rapidity_ptcut2_cent_pr_h",960,-6.,6.,epsxymin,epsxymin);  
  TProfile *eps_x_rapidity_ptcut1_mid_pr_h = new TProfile("eps_x_rapidity_ptcut1_mid_pr_h","eps_x_rapidity_ptcut1_mid_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_x_rapidity_ptcut2_mid_pr_h = new TProfile("eps_x_rapidity_ptcut2_mid_pr_h","eps_x_rapidity_ptcut2_mid_pr_h",960,-6.,6.,epsxymin,epsxymin);  
  TProfile *eps_x_rapidity_ptcut1_periph_pr_h = new TProfile("eps_x_rapidity_ptcut1_periph_pr_h","eps_x_rapidity_ptcut1_periph_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_x_rapidity_ptcut2_periph_pr_h = new TProfile("eps_x_rapidity_ptcut2_periph_pr_h","eps_x_rapidity_ptcut2_periph_pr_h",960,-6.,6.,epsxymin,epsxymin);  

  TProfile *eps_x_pt_ycut1_cent_pr_h = new TProfile("eps_x_pt_ycut1_cent_pr_h","eps_x_pt_ycut1_cent_pr_h",160,0.,2.,epsxymin,epsxymin);
  TProfile *eps_x_pt_ycut1_mid_pr_h = new TProfile("eps_x_pt_ycut1_mid_pr_h","eps_x_pt_ycut1_mid_pr_h",160,0.,2.,epsxymin,epsxymin);
  TProfile *eps_x_pt_ycut1_periph_pr_h = new TProfile("eps_x_pt_ycut1_periph_pr_h","eps_x_pt_ycut1_periph_pr_h",160,0.,2.,epsxymin,epsxymin);

  TProfile *eps_x_b_ycut1_ptcut1_pr_h = new TProfile("eps_x_b_ycut1_ptcut1_pr_h","eps_x_b_ycut1_ptcut1_pr_h",320,0.,200.,epsxymin,epsxymin);
  TProfile *eps_x_b_ycut1_ptcut2_pr_h = new TProfile("eps_x_b_ycut1_ptcut2_pr_h","eps_x_b_ycut1_ptcut2_pr_h",320,0.,200.,epsxymin,epsxymin);  

//eps_y
  TProfile *eps_y_rapidity_ptcut1_cent_pr_h = new TProfile("eps_y_rapidity_ptcut1_cent_pr_h","eps_y_rapidity_ptcut1_cent_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_y_rapidity_ptcut2_cent_pr_h = new TProfile("eps_y_rapidity_ptcut2_cent_pr_h","eps_y_rapidity_ptcut2_cent_pr_h",960,-6.,6.,epsxymin,epsxymin);  
  TProfile *eps_y_rapidity_ptcut1_mid_pr_h = new TProfile("eps_y_rapidity_ptcut1_mid_pr_h","eps_y_rapidity_ptcut1_mid_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_y_rapidity_ptcut2_mid_pr_h = new TProfile("eps_y_rapidity_ptcut2_mid_pr_h","eps_y_rapidity_ptcut2_mid_pr_h",960,-6.,6.,epsxymin,epsxymin);  
  TProfile *eps_y_rapidity_ptcut1_periph_pr_h = new TProfile("eps_y_rapidity_ptcut1_periph_pr_h","eps_y_rapidity_ptcut1_periph_pr_h",960,-6.,6.,epsxymin,epsxymin);
  TProfile *eps_y_rapidity_ptcut2_periph_pr_h = new TProfile("eps_y_rapidity_ptcut2_periph_pr_h","eps_y_rapidity_ptcut2_periph_pr_h",960,-6.,6.,epsxymin,epsxymin);  

  TProfile *eps_y_pt_ycut1_cent_pr_h = new TProfile("eps_y_pt_ycut1_cent_pr_h","eps_y_pt_ycut1_cent_pr_h",160,0.,2.,epsxymin,epsxymin);
  TProfile *eps_y_pt_ycut1_mid_pr_h = new TProfile("eps_y_pt_ycut1_mid_pr_h","eps_y_pt_ycut1_mid_pr_h",160,0.,2.,epsxymin,epsxymin);
  TProfile *eps_y_pt_ycut1_periph_pr_h = new TProfile("eps_y_pt_ycut1_periph_pr_h","eps_y_pt_ycut1_periph_pr_h",160,0.,2.,epsxymin,epsxymin);

  TProfile *eps_y_b_ycut1_ptcut1_pr_h = new TProfile("eps_y_b_ycut1_ptcut1_pr_h","eps_y_b_ycut1_ptcut1_pr_h",320,0.,200.,epsxymin,epsxymin);
  TProfile *eps_y_b_ycut1_ptcut2_pr_h = new TProfile("eps_y_b_ycut1_ptcut2_pr_h","eps_y_b_ycut1_ptcut2_pr_h",320,0.,200.,epsxymin,epsxymin);  

//rsq
double rsqmin=0.;
double rsqmax=100000.;
  TProfile *rsq_rapidity_ptcut1_cent_pr_h = new TProfile("rsq_rapidity_ptcut1_cent_pr_h","rsq_rapidity_ptcut1_cent_pr_h",960,-6.,6.,rsqmin,rsqmax);
  TProfile *rsq_rapidity_ptcut2_cent_pr_h = new TProfile("rsq_rapidity_ptcut2_cent_pr_h","rsq_rapidity_ptcut2_cent_pr_h",960,-6.,6.,rsqmin,rsqmax);  
  TProfile *rsq_rapidity_ptcut1_mid_pr_h = new TProfile("rsq_rapidity_ptcut1_mid_pr_h","rsq_rapidity_ptcut1_mid_pr_h",960,-6.,6.,rsqmin,rsqmax);
  TProfile *rsq_rapidity_ptcut2_mid_pr_h = new TProfile("rsq_rapidity_ptcut2_mid_pr_h","rsq_rapidity_ptcut2_mid_pr_h",960,-6.,6.,rsqmin,rsqmax);  
  TProfile *rsq_rapidity_ptcut1_periph_pr_h = new TProfile("rsq_rapidity_ptcut1_periph_pr_h","rsq_rapidity_ptcut1_periph_pr_h",960,-6.,6.,rsqmin,rsqmax);
  TProfile *rsq_rapidity_ptcut2_periph_pr_h = new TProfile("rsq_rapidity_ptcut2_periph_pr_h","rsq_rapidity_ptcut2_periph_pr_h",960,-6.,6.,rsqmin,rsqmax);  

  TProfile *rsq_pt_ycut1_cent_pr_h = new TProfile("rsq_pt_ycut1_cent_pr_h","rsq_pt_ycut1_cent_pr_h",160,0.,2.,rsqmin,rsqmax);
  TProfile *rsq_pt_ycut1_mid_pr_h = new TProfile("rsq_pt_ycut1_mid_pr_h","rsq_pt_ycut1_mid_pr_h",160,0.,2.,rsqmin,rsqmax);
  TProfile *rsq_pt_ycut1_periph_pr_h = new TProfile("rsq_pt_ycut1_periph_pr_h","rsq_pt_ycut1_periph_pr_h",160,0.,2.,rsqmin,rsqmax);

  TProfile *rsq_b_ycut1_ptcut1_pr_h = new TProfile("rsq_b_ycut1_ptcut1_pr_h","rsq_b_ycut1_ptcut1_pr_h",320,0.,200.,rsqmin,rsqmax);
  TProfile *rsq_b_ycut1_ptcut2_pr_h = new TProfile("rsq_b_ycut1_ptcut2_pr_h","rsq_b_ycut1_ptcut2_pr_h",320,0.,200.,rsqmin,rsqmax);  
...
TH2D *xvsz_cent = new TH2D("xvsz_cent","xvsz_cent",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid = new TH2D("xvsz_mid","xvsz_mid",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph = new TH2D("xvsz_periph","xvsz_periph",1000,-200.,200.,1000,-200.,200.);

 TH2D *xvsz_cent_binm4 = new TH2D("xvsz_cent_binm4","xvsz_cent_binm4",1000,-200.,200.,1000,-200.,200.);
 TH2D *xvsz_cent_binm3 = new TH2D("xvsz_cent_binm3","xvsz_cent_binm3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binm2 = new TH2D("xvsz_cent_binm2","xvsz_cent_binm2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binm1 = new TH2D("xvsz_cent_binm1","xvsz_cent_binm1",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_bin0 = new TH2D("xvsz_cent_bin0","xvsz_cent_bin0",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binp4 = new TH2D("xvsz_cent_binp4","xvsz_cent_binp4",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binp3 = new TH2D("xvsz_cent_binp3","xvsz_cent_binp3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binp2 = new TH2D("xvsz_cent_binp2","xvsz_cent_binp2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_cent_binp1 = new TH2D("xvsz_cent_binp1","xvsz_cent_binp1",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binm4 = new TH2D("xvsz_mid_binm4","xvsz_mid_binm4",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binm3 = new TH2D("xvsz_mid_binm3","xvsz_mid_binm3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binm2 = new TH2D("xvsz_mid_binm2","xvsz_mid_binm2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binm1 = new TH2D("xvsz_mid_binm1","xvsz_mid_binm1",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_bin0 = new TH2D("xvsz_mid_bin0","xvsz_mid_bin0",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binp4 = new TH2D("xvsz_mid_binp4","xvsz_mid_binp4",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binp3 = new TH2D("xvsz_mid_binp3","xvsz_mid_binp3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binp2 = new TH2D("xvsz_mid_binp2","xvsz_mid_binp2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_mid_binp1 = new TH2D("xvsz_mid_binp1","xvsz_mid_binp1",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binm4 = new TH2D("xvsz_periph_binm4","xvsz_periph_binm4",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binm3 = new TH2D("xvsz_periph_binm3","xvsz_periph_binm3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binm2 = new TH2D("xvsz_periph_binm2","xvsz_periph_binm2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binm1 = new TH2D("xvsz_periph_binm1","xvsz_periph_binm1",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_bin0 = new TH2D("xvsz_periph_bin0","xvsz_periph_bin0",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binp4 = new TH2D("xvsz_periph_binp4","xvsz_periph_binp4",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binp3 = new TH2D("xvsz_periph_binp3","xvsz_periph_binp3",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binp2 = new TH2D("xvsz_periph_binp2","xvsz_periph_binp2",1000,-200.,200.,1000,-200.,200.);
TH2D *xvsz_periph_binp1 = new TH2D("xvsz_periph_binp1","xvsz_periph_binp1",1000,-200.,200.,1000,-200.,200.);
...
// centrality dependent new values
	...
	if(iptbin==3 && -abs(iybin)==0)
      ...
      */
      ...
      if(cent){xvsz_cent->Fill(x[i],z[i]);}
      if(mid){xvsz_mid->Fill(x[i],z[i]);}
      if(periph){xvsz_periph->Fill(x[i],z[i]);}
	...
	xvsz_periph_binm4->Fill(x[i],z[i]);
      }
      if(periph && iybin==-3){
	...
	xvsz_periph_binm3->Fill(x[i],z[i]);
      }
      if(periph && iybin==-2){
	...
	xvsz_periph_binm2->Fill(x[i],z[i]);
      }
      if(periph && iybin==-1){
	...
	xvsz_periph_binm1->Fill(x[i],z[i]);
      }
      if(periph && iybin==0){
	...
	xvsz_periph_binp4->Fill(x[i],z[i]);
      }
      if(periph && iybin==3){
	...
	xvsz_periph_binp3->Fill(x[i],z[i]);
      }
      if(periph && iybin==2){
	...
	xvsz_periph_binp2->Fill(x[i],z[i]);
      }
      if(periph && iybin==1){
	...
	xvsz_periph_binp1->Fill(x[i],z[i]);
      }
...
//----------------------------------------- end finding eccentricities ---------------------
  ...
  //
  TFile *myfile = new TFile("smash2ana7.root","RECREATE");
  infoh->Write();
...
xvsz_cent_binm4->Write();
xvsz_cent_binm3->Write();
xvsz_cent_binm2->Write();
xvsz_cent_binm1->Write();
xvsz_cent_bin0->Write();
xvsz_cent_binp4->Write();
xvsz_cent_binp3->Write();
xvsz_cent_binp2->Write();
xvsz_cent_binp1->Write();
xvsz_mid_binm4->Write();
xvsz_mid_binm3->Write();
xvsz_mid_binm2->Write();
xvsz_mid_binm1->Write();
xvsz_mid_bin0->Write();
xvsz_mid_binp4->Write();
xvsz_mid_binp3->Write();
xvsz_mid_binp2->Write();
xvsz_mid_binp1->Write();
xvsz_periph_binm4->Write();
xvsz_periph_binm3->Write();
xvsz_periph_binm2->Write();
xvsz_periph_binm1->Write();
xvsz_periph_bin0->Write();
xvsz_periph_binp4->Write();
xvsz_periph_binp3->Write();
xvsz_periph_binp2->Write();
xvsz_periph_binp1->Write();
