...
void smash2ana1(int itype=5,int ntodo=-1, int irot=0, int i_inject=0, double Ecm=7.7, double bmin=0., double bmax=14.) {
  ...
  TH2D *xvsy_p_pt0_binm4 = new TH2D("xvsy_p_pt0_binm4","xvsy_p_pt0_binm4",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binm3 = new TH2D("xvsy_p_pt0_binm3","xvsy_p_pt0_binm3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binm2 = new TH2D("xvsy_p_pt0_binm2","xvsy_p_pt0_binm2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binm1 = new TH2D("xvsy_p_pt0_binm1","xvsy_p_pt0_binm1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_bin0 = new TH2D("xvsy_p_pt0_bin0","xvsy_p_pt0_bin0",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binp1 = new TH2D("xvsy_p_pt0_binp1","xvsy_p_pt0_binp1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binp2 = new TH2D("xvsy_p_pt0_binp2","xvsy_p_pt0_binp2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binp3 = new TH2D("xvsy_p_pt0_binp3","xvsy_p_pt0_binp3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt0_binp4 = new TH2D("xvsy_p_pt0_binp4","xvsy_p_pt0_binp4",1000,-200.,200.,1000,-200.,200.);      
  
  TH2D *xvsy_p_pt1_binm4 = new TH2D("xvsy_p_pt1_binm4","xvsy_p_pt1_binm4",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binm3 = new TH2D("xvsy_p_pt1_binm3","xvsy_p_pt1_binm3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binm2 = new TH2D("xvsy_p_pt1_binm2","xvsy_p_pt1_binm2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binm1 = new TH2D("xvsy_p_pt1_binm1","xvsy_p_pt1_binm1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_bin0 = new TH2D("xvsy_p_pt1_bin0","xvsy_p_pt1_bin0",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binp1 = new TH2D("xvsy_p_pt1_binp1","xvsy_p_pt1_binp1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binp2 = new TH2D("xvsy_p_pt1_binp2","xvsy_p_pt1_binp2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binp3 = new TH2D("xvsy_p_pt1_binp3","xvsy_p_pt1_binp3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt1_binp4 = new TH2D("xvsy_p_pt1_binp4","xvsy_p_pt1_binp4",1000,-200.,200.,1000,-200.,200.);      
  
  TH2D *xvsy_p_pt2_binm4 = new TH2D("xvsy_p_pt2_binm4","xvsy_p_pt2_binm4",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binm3 = new TH2D("xvsy_p_pt2_binm3","xvsy_p_pt2_binm3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binm2 = new TH2D("xvsy_p_pt2_binm2","xvsy_p_pt2_binm2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binm1 = new TH2D("xvsy_p_pt2_binm1","xvsy_p_pt2_binm1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_bin0 = new TH2D("xvsy_p_pt2_bin0","xvsy_p_pt2_bin0",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binp1 = new TH2D("xvsy_p_pt2_binp1","xvsy_p_pt2_binp1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binp2 = new TH2D("xvsy_p_pt2_binp2","xvsy_p_pt2_binp2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binp3 = new TH2D("xvsy_p_pt2_binp3","xvsy_p_pt2_binp3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt2_binp4 = new TH2D("xvsy_p_pt2_binp4","xvsy_p_pt2_binp4",1000,-200.,200.,1000,-200.,200.);      

  TH2D *xvsy_p_pt3_binm4 = new TH2D("xvsy_p_pt3_binm4","xvsy_p_pt3_binm4",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binm3 = new TH2D("xvsy_p_pt3_binm3","xvsy_p_pt3_binm3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binm2 = new TH2D("xvsy_p_pt3_binm2","xvsy_p_pt3_binm2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binm1 = new TH2D("xvsy_p_pt3_binm1","xvsy_p_pt3_binm1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_bin0 = new TH2D("xvsy_p_pt3_bin0","xvsy_p_pt3_bin0",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binp1 = new TH2D("xvsy_p_pt3_binp1","xvsy_p_pt3_binp1",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binp2 = new TH2D("xvsy_p_pt3_binp2","xvsy_p_pt3_binp2",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binp3 = new TH2D("xvsy_p_pt3_binp3","xvsy_p_pt3_binp3",1000,-200.,200.,1000,-200.,200.);
  TH2D *xvsy_p_pt3_binp4 = new TH2D("xvsy_p_pt3_binp4","xvsy_p_pt3_binp4",1000,-200.,200.,1000,-200.,200.);      
  ...
  for(int iev=0; iev<nev; iev++){
   ...
   //    double bmin=0;
	...
	ncollpartspech->Fill(ncollpart[i]);
      ...
      int iybin=0;
      if(abs(rapidity[i])>0.10)iybin=1*rapidity[i]/abs(rapidity[i]);
      if(abs(rapidity[i])>0.35)iybin=2*rapidity[i]/abs(rapidity[i]);
      if(abs(rapidity[i])>0.60)iybin=3*rapidity[i]/abs(rapidity[i]);
      if(abs(rapidity[i])>0.85)iybin=4*rapidity[i]/abs(rapidity[i]);
	...
	if(b_impact>=8.5 && b_impact<10.4){ //40-60%
      ...
      //      /*     
      // recenter (from xy plots) for SMASH Aug 1, 2022. from running plotshams2xy (doplotxyeps)
      double xx0=0;
      double yy0=0;
      double rsqmax=0;
      // FOR SMASH
      if(iptbin==0 && iybin== -4 ){ xx0= -7.49164; yy0=0.0;  rsqmax=15.825;}
      if(iptbin==0 && iybin== -3 ){ xx0= -7.33027; yy0=0.0;  rsqmax=17.093;}
      if(iptbin==0 && iybin== -2 ){ xx0= -3.9663; yy0=0.0;  rsqmax=19.0204;}
      if(iptbin==0 && iybin== -1 ){ xx0= -1.94406; yy0=0.0;  rsqmax=20.8374;}
      if(iptbin==0 && iybin== 0 ){ xx0= 0.0140442; yy0=0.0;  rsqmax=21.9286;}
      
      if(iptbin==1 && iybin== -4 ){ xx0= -9.42441; yy0=0.0;  rsqmax=28.5204;}
      if(iptbin==1 && iybin== -3 ){ xx0= -9.74216; yy0=0.0;  rsqmax=33.6741;}
      if(iptbin==1 && iybin== -2 ){ xx0= -6.44205; yy0=0.0;  rsqmax=44.8622;}
      if(iptbin==1 && iybin== -1 ){ xx0= -3.53071; yy0=0.0;  rsqmax=50.8192;}
      if(iptbin==1 && iybin== 0 ){ xx0= -0.00221719; yy0=0.0;  rsqmax=53.9437;}
      
      if(iptbin==2 && iybin== -4 ){ xx0= -19.7565; yy0=0.0;  rsqmax=59.9122;}
      if(iptbin==2 && iybin== -3 ){ xx0= -22.5632; yy0=0.0;  rsqmax=84.8406;}
      if(iptbin==2 && iybin== -2 ){ xx0= -19.4787; yy0=0.0;  rsqmax=112.058;}
      if(iptbin==2 && iybin== -1 ){ xx0= -12.4148; yy0=0.0;  rsqmax=131.653;}
      if(iptbin==2 && iybin== 0 ){ xx0= 0.0095362; yy0=0.0;  rsqmax=142.633;}
      
      if(iptbin==3 && iybin== -4 ){ xx0= -50.7465; yy0=0.0;  rsqmax=103.447;}
      if(iptbin==3 && iybin== -3 ){ xx0= -46.6321; yy0=0.0;  rsqmax=135.622;}
      if(iptbin==3 && iybin== -2 ){ xx0= -36.7544; yy0=0.0;  rsqmax=168.955;}
      if(iptbin==3 && iybin== -1 ){ xx0= -22.8211; yy0=0.0;  rsqmax=196.037;}
      if(iptbin==3 && iybin== 0 ){ xx0= -0.0121463; yy0=0.0;  rsqmax=211.575;}
