...
void jam1ana6(int itype=5,int ntodo=-1, int irot=0, int i_inject=0, double Ecm=7.7, double bmin=0., double bmax=14.) {
...
//----------------------------------------- end finding eccentricities ---------------------
  ...
  //
  TFile *myfile = new TFile("jam1ana6.root","RECREATE");
  infoh->Write();
