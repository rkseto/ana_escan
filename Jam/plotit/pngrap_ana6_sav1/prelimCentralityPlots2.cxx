...
void prelimCentralityPlots2(int ido=1, string dat2s="JAM1 3 GeV - hard2 potential b=0-14")
{
  ...
  prLegend2->AddEntry(cth_3_b_ycut1_ptcut1_pip_b2, " #pi^{+} SMASH2 "); // pip
  prLegend2->AddEntry(cth_3_b_ycut1_ptcut1_pim_c2, " #pi^{-} SMASH2"); //  pim
  prLegend2->AddEntry(cth_3_b_ycut1_ptcut1_pr_a2, " p SMASH2 ");
