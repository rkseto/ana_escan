...
void prelimRapidityPlots2(int ido=1, string dat2s="JAM1 3 GeV - hard2 potential b=0-14")
{
  ...
  prRapidityStack->Draw();
  prRapidityStack->SetMaximum(0.04);
  ...
  cth_3_rapidity_ptcut1_cent_pr_a->SetMaximum(0.06);
  cth_3_rapidity_ptcut1_cent_pr_a->SetMinimum(-0.06);
  ...
  cth_3_rapidity_ptcut1_periph_pr_a->SetMaximum(0.06);
  cth_3_rapidity_ptcut1_periph_pr_a->SetMinimum(-0.06);
  ...
  cth_3_rapidity_ptcut1_mid_pr_a->SetMaximum(0.06);
  cth_3_rapidity_ptcut1_mid_pr_a->SetMinimum(-0.06);
